...
VALUES
  ('towing', 'Towing', 'Truck', 150, 300, true),
  ('battery', 'Battery Jumpstart & Replacement', 'Battery', 50, 350, true),
  ('tyre', 'Tyre Replacement', 'CircleDashed', 60, 150, true),
  ('fuel', 'Fuel Delivery', 'Fuel', 40, 80, true),
  ('lockout', 'Lockout Service', 'Key', 80, 150, true),
  ('repair', 'Breakdown Repair', 'Wrench', 100, 500, true),
  ('wash', 'Mobile Car Wash', 'Droplets', 50, 200, true),
